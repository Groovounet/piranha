...
void CObjectGE::Cube (const gtl::CVector3<float> & Position, const gtl::CVector3<float> & Size)
{
...
void CObjectGE::Cylinder (float fRadius, float fLenght, float fDivisionX, float fDivisionZ)
{
...
void CObjectGE::Plane (const gtl::CVector3<float> & Position, const gtl::CVector2<float> & Size, const gtl::CVector2<float> & Division)
{
    float x = Position (gtl::X) - Size (gtl::X) / 2;
	float y = Position (gtl::Y) - Size (gtl::Y) / 2;
...
void CObjectGE::Sphere (float fRayon, unsigned int uiHorizontal, unsigned int uiVertical)
{
