...
#ifndef __PIRANHA_GL_OBJECT_DL_H__
#define __PIRANHA_GL_OBJECT_DL_H__

#include "./object.h"

namespace gl {

class CObjectDL : public CObject
{
private:
...
public:
    ...
    void Disk (float fRadius, unsigned int uiDivision);
...
#endif //__PIRANHA_GL_OBJECT_DL_H__
